...
class AtualizarOitavas:
    ...
    def __init__(self):
        ...
        self.s = [['-', 'imagens/bandeira.png', ''] for i in range(17)]
        ...
        self.s9_str = StringVar(value=self.s[9][0])
        self.s9_band = StringVar(value=self.s[9][1])
        self.s9_gol = StringVar(value=self.s[9][2])

        self.s10_str = StringVar(value=self.s[10][0])
        self.s10_band = StringVar(value=self.s[10][1])
        self.s10_gol = StringVar(value=self.s[10][2])

        self.s11_str = StringVar(value=self.s[11][0])
        self.s11_band = StringVar(value=self.s[11][1])
        self.s11_gol = StringVar(value=self.s[11][2])

        self.s12_str = StringVar(value=self.s[12][0])
        self.s12_band = StringVar(value=self.s[12][1])
        self.s12_gol = StringVar(value=self.s[12][2])

        self.s13_str = StringVar(value=self.s[13][0])
        self.s13_band = StringVar(value=self.s[13][1])
        self.s13_gol = StringVar(value=self.s[13][2])

        self.s14_str = StringVar(value=self.s[14][0])
        self.s14_band = StringVar(value=self.s[14][1])
        self.s14_gol = StringVar(value=self.s[14][2])

        self.s15_str = StringVar(value=self.s[15][0])
        self.s15_band = StringVar(value=self.s[15][1])
        self.s15_gol = StringVar(value=self.s[15][2])

        self.s16_str = StringVar(value=self.s[16][0])
        self.s16_band = StringVar(value=self.s[16][1])
        self.s16_gol = StringVar(value=self.s[16][2])
    ...
    def atualizar(self, dados: list):
        ...
        self.s9_str.set(value=dados[9][0])
        self.s9_band.set(value=dados[9][1])
        self.s9_gol.set(value=dados[9][2])

        self.s10_str.set(value=dados[10][0])
        self.s10_band.set(value=dados[10][1])
        self.s10_gol.set(value=dados[10][2])

        self.s11_str.set(value=dados[11][0])
        self.s11_band.set(value=dados[11][1])
        self.s11_gol.set(value=dados[11][2])

        self.s12_str.set(value=dados[12][0])
        self.s12_band.set(value=dados[12][1])
        self.s12_gol.set(value=dados[12][2])

        self.s13_str.set(value=dados[13][0])
        self.s13_band.set(value=dados[13][1])
        self.s13_gol.set(value=dados[13][2])

        self.s14_str.set(value=dados[14][0])
        self.s14_band.set(value=dados[14][1])
        self.s14_gol.set(value=dados[14][2])

        self.s15_str.set(value=dados[15][0])
        self.s15_band.set(value=dados[15][1])
        self.s15_gol.set(value=dados[15][2])

        self.s16_str.set(value=dados[16][0])
        self.s16_band.set(value=dados[16][1])
        self.s16_gol.set(value=dados[16][2])
